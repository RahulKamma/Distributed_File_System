...
def deleteFile():
    global username, text
    global dirname
    #dirname = simpledialog.askstring(title="Please enter file/directory name to delete", prompt="Please enter file/directory name to delete")
...
def writeFile():
    ...
    if current_name != username:
        con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'distributed',charset='utf8')
        with con:
            cur = con.cursor()
    ...
    if current_name == username or status == 'Write':
        ...
        messagebox.showinfo("You dont have permission to write to this file","You dont have permission to write to this file")
...
def shareAccess():
    ...
    db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'distributed',charset='utf8')
